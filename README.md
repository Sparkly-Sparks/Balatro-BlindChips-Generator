...
This is a command line interface (and files) for creating textures for boss blinds for mods for the game Balatro.
...
4. Run and use BBG(CLI).exe. It will open in a terminal.
Modes:
